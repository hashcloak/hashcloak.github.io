    ...
    <div className={`fixed inset-0 z-50 bg-white transition-transform duration-300 ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
      ...
      <nav className="p-4">
        <ul className="space-y-4">
          <li><a href="#home" className="block py-2 text-lg font-medium hover:text-indigo-600" onClick={() => setMobileMenuOpen(false)}>Home</a></li>
        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-8">
              <li><a href="home" className="text-sm font-medium hover:text-indigo-600">Home</a></li>
